// Major worldwide sea ports - Comprehensive list based on Wikipedia container ports
export const WORLD_PORTS = [
  ...
  "Surabaya (Tanjung Perak), Indonesia",
  "Belawan, Indonesia",
  "Makassar, Indonesia",
  "Semarang (Tanjung Mas), Indonesia",
  "Banjarmasin (Trisakti), Indonesia",
  "Balikpapan (Semayang), Indonesia",
  "Cirebon, Indonesia",
  "Pontianak (Dwikora), Indonesia",
  "Kupang (Tenau), Indonesia",
  "Bitung, Indonesia",
  "Palembang, Indonesia",
  "Panjang (Lampung), Indonesia",
  "Sorong, Indonesia",
  "Ambon, Indonesia",
